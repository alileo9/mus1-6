...
async def restart(client, m: Message):
    ...
    await jmthon.edit("8")
    await jmthon.edit("9")
    await jmthon.edit("**تم اعادة تشغيل سورس السلطان ميوزك بنجاح ✓**")
...
• {HNDLR}الاوامر - لعرض اوامر سورس ميوزك السلطان
